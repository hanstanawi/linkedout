    ...
    <div className="min-h-full px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
      <div className="mx-auto max-w-max">
        <main className="sm:flex">
          <p className="text-4xl font-bold tracking-tight text-blue-500 sm:text-5xl">
            404
          </p>
          <div className="sm:ml-6">
            ...
            <div className="mt-10 flex items-center space-x-3 sm:border-l sm:border-transparent sm:pl-6">
              <Link
                to="/"
